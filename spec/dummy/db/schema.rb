...
ActiveRecord::Schema.define(version: 2022_01_25_144339) do
  ...
  create_table "articles", force: :cascade do |t|
    ...
    t.string "language"
    t.string "excerpt", limit: 144
    t.string "content_hash", null: false
    t.json "metadata", default: "{}", null: false
    t.string "status", null: false
    t.boolean "is_private", default: false, null: false
    t.datetime "discared_at", precision: 6
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["author_id"], name: "index_articles_on_author_id"
    t.index ["content_hash"], name: "index_articles_on_content_hash"
    t.index ["discared_at"], name: "index_articles_on_discared_at"
